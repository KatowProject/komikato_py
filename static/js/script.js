                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item"><b>Pengarang:</b> ${data.author}</li>
                                <li class="list-group-item"><b>Ilustrator:</b> ${data.illustrator}</li>
                                <li class="list-group-item"><b>Genre:</b> ${data.genres.map(a => `<a href="${a.link}">${a.name}</a>`).join(', ')}</li>
